        ...
        <form className="booking-form" action="https://echo.htmlacademy.ru/" method="post">
          <fieldset className="booking-form__section">
            ...
            <fieldset className="booking-form__date-section">
              ...
              <div className="booking-form__date-inner-wrapper">
                <label className="custom-radio booking-form__date">
                  <input type="radio" id="today9h45m" name="date" value="today9h45m" required />
                  <span className="custom-radio__label">9:45</span>
                </label>
                <label className="custom-radio booking-form__date">
                  <input type="radio" id="today15h00m" name="date" value="today15h00m" required checked />
                  <span className="custom-radio__label" >15:00</span>
                </label>
                <label className="custom-radio booking-form__date">
                  <input type="radio" id="today17h30m" name="date" value="today17h30m" required />
                  <span className="custom-radio__label">17:30</span>
                </label>
                <label className="custom-radio booking-form__date">
                  <input type="radio" id="today19h30m" name="date" value="today19h30m" required disabled />
            ...
            <fieldset className="booking-form__date-section">
              ...
              <div className="booking-form__date-inner-wrapper">
                <label className="custom-radio booking-form__date">
                  <input type="radio" id="tomorrow11h00m" name="date" value="tomorrow11h00m" required />
                  <span className="custom-radio__label">11:00</span>
                </label>
                <label className="custom-radio booking-form__date">
                  <input type="radio" id="tomorrow15h00m" name="date" value="tomorrow15h00m" disabled required />
                  <span className="custom-radio__label">15:00</span>
                </label>
                <label className="custom-radio booking-form__date">
                  <input type="radio" id="tomorrow17h30m" name="date" value="tomorrow17h30m" disabled required />
                  <span className="custom-radio__label">17:30</span>
                </label>
                <label className="custom-radio booking-form__date">
                  <input type="radio" id="tomorrow19h45m" name="date" value="tomorrow19h45m" required />
                  <span className="custom-radio__label">19:45</span>
                </label>
                <label className="custom-radio booking-form__date">
                  <input type="radio" id="tomorrow21h30m" name="date" value="tomorrow21h30m" required />
                  <span className="custom-radio__label">21:30</span>
                </label>
              </div>
            </fieldset>
          ...
          <fieldset className="booking-form__section">
            ...
            <div className="custom-input booking-form__input">
              ...
              <input type="tel" id="tel" name="tel" placeholder="Телефон" pattern="[0-9]{10,}" required />
            </div>
            <div className="custom-input booking-form__input">
